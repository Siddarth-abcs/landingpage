...
const HeroSection = () => {
  return (
    <div className="w-5/6 h-full md:h-screen m-auto flex flex-col lg:flex-row items-center md:gap-x-6">
      {/* Text part */}
      <div className="w-full lg:mb-0 lg:mt-8 mt-32 md:mt-40 lg:w-1/2 mb-8">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-2xl lg:text-4xl font-bold text-black text-center lg:text-left leading-normal lg:leading-relaxed">
            ...
            Our
            <span className="text-black"> App Development services</span>{" "}
            Tackles Your Pain Points
          </h1>
          <p className="mt-4 text-sm lg:text-xl text-center lg:text-left text-gray-700 leading-normal lg:leading-relaxed">
      ...
      {/* Contact box */}
      <div className="lg:w-1/2 lg:ml-5 shadow-md rounded-xl bg-white mt-6 flex flex-col items-start justify-center p-6 box-border gap-8 max-w-full z-10 text-xl text-gray-900">
        ...
        <div className="self-stretch flex flex-row flex-wrap items-end justify-start gap-6 max-w-full text-base text-gray-700">
          <div className="flex-1 flex flex-col items-start justify-center gap-4 max-w-full">
            <div className="self-stretch flex flex-col md:flex-row md:items-center justify-start gap-2 md:gap-6">
              <div className="flex-1 flex flex-col items-start justify-start pt-0 px-0 pb-0 box-border gap-2 min-w-[146px]">
                ...
                <input
                  className="border-none outline-none bg-transparent h-6 text-base text-gray-900"
                  placeholder="My Name"
                  type="text"
                />
                <img
